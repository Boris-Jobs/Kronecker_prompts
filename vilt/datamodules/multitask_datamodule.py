...
from . import _datamodules  # vilt.datamodules.__init__
import ipdb
...
class MTDataModule(LightningDataModule):
    def __init__(self, _config, dist=False):
        ...
        # 运行语句中，指定task_finetune_mmimdb()方法，即可改变此处的_config["datasets"]为所需测试或训练的dataset
        # ipdb.set_trace()
    ...
    def train_dataloader(self):
        ...
        # Print the properties of the DataLoader
