...
srun -N 1 -n 1 -c 3 -t 33:33:33 --mem-per-cpu=32G --gres=gpu:a100:2 \
     ...
     exp_name=perfect_hateful_memes_kronecker_trainm_b_testm_t \
     | tee -a /scratch/project_2007023/boris/missing_aware_prompts/missing_aware_prompts/result/perfect_hateful_memes_kronecker_trainm_b_testm_t.txt
