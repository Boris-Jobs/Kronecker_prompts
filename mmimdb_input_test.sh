...
srun -N 1 -n 1 -c 3 -t 00:15:00 --mem-per-cpu=32G --gres=gpu:a100:2 \
     ...
     input_prompts \
     step50k \
     load_path=/scratch/project_2007023/boris/missing_aware_prompts/missing_aware_prompts/result/imdb_input_train_seed0_from_vilt_200k_mlm_itm/version_0/checkpoints/last.ckpt  \
